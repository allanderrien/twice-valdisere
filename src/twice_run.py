...
ASSETS = [
    {"id":"forfaits_bellevarde","nom":"Forfaits — Secteur Bellevarde","type":"forfaits","secteur":"bellevarde",
     "lat":45.459895,"lon":6.964239,"ca_jour":330000,
     "remontees_critiques":{"olympique":4,"funival":3,"daille":2}},
    {"id":"forfaits_solaise","nom":"Forfaits — Secteur Solaise","type":"forfaits","secteur":"solaise",
     "lat":45.447003,"lon":6.977122,"ca_jour":230000,
     "remontees_critiques":{"solaise":5}},
    {"id":"forfaits_fornet","nom":"Forfaits — Secteur Fornet/Pissaillas","type":"forfaits","secteur":"fornet",
     "lat":45.450518,"lon":7.011463,"ca_jour":110000,
     "remontees_critiques":{"fornet":5}},
    {"id":"folie_douce","nom":"La Folie Douce","type":"restaurant","secteur":"bellevarde",
     "lat":45.456600,"lon":6.943624,"ca_jour":55000,
     "remontees_critiques":{"daille":4,"olympique":2}},
    {"id":"bellevarde_resto","nom":"Le Bellevarde / Maison Louly","type":"restaurant","secteur":"bellevarde",
     "lat":45.441884,"lon":6.950299,"ca_jour":35000,
     "remontees_critiques":{"olympique":4,"funival":3}},
    {"id":"refuge_solaise","nom":"Le Refuge de Solaise","type":"restaurant","secteur":"solaise",
     "lat":45.434621,"lon":6.992611,"ca_jour":28000,
     "remontees_critiques":{"solaise":5}},
    {"id":"ouillette","nom":"L'Ouillette","type":"restaurant","secteur":"solaise",
     "lat":45.429652,"lon":6.994509,"ca_jour":18000,
     "remontees_critiques":{"solaise":5}},
    {"id":"signal_fornet","nom":"Le Signal (Fornet)","type":"restaurant","secteur":"fornet",
     "lat":45.442309,"lon":7.017119,"ca_jour":22000,
     "remontees_critiques":{"fornet":5}},
    {"id":"cascade_pissaillas","nom":"La Cascade (Pissaillas)","type":"restaurant","secteur":"fornet",
     "lat":45.421742,"lon":7.040656,"ca_jour":15000,
     "remontees_critiques":{"fornet":4}},
    {"id":"esf","nom":"ESF Val d'Isère","type":"ecole_ski","secteur":"station",
     "lat":45.448225,"lon":6.979829,"ca_jour":95000,
...
def fetch_meteo():
    ...
    params = {
        ...
        "wind_speed_unit":"kmh","past_days":PAST_DAYS,
        "forecast_days":FORECAST_DAYS,"timezone":"Europe/Paris",
    }
...
def accessibilite(asset, statuts):
    ...
    for rid, p in asset["remontees_critiques"].items():
        score += p * STATUT_SCORE.get(statuts.get(rid, "ouvert"), 1.0)
        poids += p
...
def run():
    ...
    rapport = {
        ...
        "now_index":now_index,
        "hypotheses":{
            "H1":"Indice alea = max(vent/80, neige/20) + 0.2 si temp<-15C",
        ...
        "meteo":{"times":times,"vent":vent,"neige":neige,"temp":temp,"now_index":now_index},
